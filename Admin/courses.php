...
<body>
    ...
    <main class="main" id="main">
        ...
        9999">
            <button id="courseAddBtn" type="button" class=" hover:text-blue-600">Add Courses</button>
            <span>|</span>
            <button id="addSubjectBtn" class=" hover:text-blue-600">Add Subjects</button>
        </nav>
            ...
            <table class="courseTables border-2 border-black  border-collapse  table-fixed   w-full">
                <thead>
                    <tr class="">
                        ...
                        <th class="border border-black overflow-hidden text-nowrap text-ellipsis hover:text-clip ">Add
                            Branches</th>
                        <th class="border border-black  overflow-hidden text-nowrap text-ellipsis hover:text-clip ">
                            Action</th>
                    </tr>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td class="border  hover:text-clip flex justify-center items-baseline gap-4 font-bold">
                                    <div>
                                        <button id="" data-courseId="' . $row['id'] . '" class="   courseUpdateBtn   text-blue-500 hover:text-blue-700"><i class="fa-solid fa-pen"></i><span class="hidden md:inline-block">Update</span></button>
                                    </div>
                                    <div class="">
                                        ...
                                        <form method="post" onsubmit="return confirmDeleteCourse(\'' . $row['courseName'] . '\')"  class="">
                                                ...
                                                <button type="submit" class=" text-red-500 hover:text-red-700"><i class="fa-solid fa-trash-can"></i><span class="hidden md:inline-block">Delete</span></button>
                                        </form> 
                                    </div>
                           </td>';
                            echo "</tr>";
            ...
            <table class="table table-fixed w-full border-collapse border-2 border-black" id="myTable">
                <thead>
                    <tr>
                        ...
                        <th class="border border-black text-ellipsis text-nowrap overflow-hidden py-4">Year
                        </th>
                        <th class="border border-black text-ellipsis text-nowrap overflow-hidden py-4">Action</th>
